...
HD_PWD='H:/FPGA-Neural-Network-/ip_repo/DMA_Test/DMA_Test.runs/design_1_axis_fifo_test_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axis_fifo_test_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axis_fifo_test_0_0.tcl
