...
HD_PWD='h:/fpga-neural-network-/ip_repo/edit_axis_fifo_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_fifo_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axis_fifo_v1_0.tcl
