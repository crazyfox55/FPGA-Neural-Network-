...
set rc [catch {
  ...
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file axis_fifo_v1_0_control_sets_placed.rpt"
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file axis_fifo_v1_0_timing_summary_routed.rpt -warn_on_violation  -rpx axis_fifo_v1_0_timing_summary_routed.rpx"
