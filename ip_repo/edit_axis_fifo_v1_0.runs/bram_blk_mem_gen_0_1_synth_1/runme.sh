...
HD_PWD='H:/FPGA-Neural-Network-/ip_repo/edit_axis_fifo_v1_0.runs/bram_blk_mem_gen_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_blk_mem_gen_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_blk_mem_gen_0_1.tcl
