...
HD_PWD='H:/FPGA-Neural-Network-/System/System.runs/System_axis_fifo_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log System_axis_fifo_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source System_axis_fifo_0_0.tcl
