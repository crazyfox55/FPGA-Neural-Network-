...
#
# Generated by export_simulation on Sun Apr 29 16:26:39 -0500 2018
#
################################################################################
...
'-reset_run' switch to the './bram_blk_mem_gen_0_0.sh' script.

./bram_blk_mem_gen_0_0.sh -reset_run
...
./bram_blk_mem_gen_0_0.sh -noclean_files

For more information on the script, please type './bram_blk_mem_gen_0_0.sh -help'.
