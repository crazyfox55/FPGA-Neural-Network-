...
HD_PWD='H:/FPGA-Neural-Network-/fpga/fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DotProduct.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DotProduct.tcl -notrace
