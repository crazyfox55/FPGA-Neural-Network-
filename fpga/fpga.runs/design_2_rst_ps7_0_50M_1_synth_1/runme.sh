...
HD_PWD='H:/FPGA-Neural-Network-/fpga/fpga.runs/design_2_rst_ps7_0_50M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_rst_ps7_0_50M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_rst_ps7_0_50M_1.tcl
