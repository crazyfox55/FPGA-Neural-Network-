...
HD_PWD='H:/FPGA-Neural-Network-/fpga/fpga.runs/design_2_axis_fifo_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_axis_fifo_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_axis_fifo_0_1.tcl
