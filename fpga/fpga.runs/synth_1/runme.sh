...
HD_PWD='H:/FPGA-Neural-Network-/fpga/fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ConvEngine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ConvEngine.tcl
